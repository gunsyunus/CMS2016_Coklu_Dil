...
<div class="row">
  ...
  <div class="col-xs-4 col-sm-6 col-md-4 modul-button">
    <a class="btn btn-success" href="{{ URL::to('Pv3/photo/new') }}"><i class="fa fa-plus-circle"></i> Galeri</a>
    <a class="btn btn-info" href="{{ URL::to('Pv3/photo') }}"><i class="fa fa-list"></i> Liste</a>
  </div>
</div>
</div>
