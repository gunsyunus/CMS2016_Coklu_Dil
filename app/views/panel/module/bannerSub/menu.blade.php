...
<div class="row">
  ...
  <div class="col-xs-4 col-sm-6 col-md-4 modul-button">
    <a class="btn btn-success" href="{{ URL::to('Pv3/banner-sub/new') }}"><i class="fa fa-plus-circle"></i></a>
    <a class="btn btn-info" href="{{ URL::to('Pv3/banner-sub') }}"><i class="fa fa-list"></i></a>
  </div>
</div>
</div>
