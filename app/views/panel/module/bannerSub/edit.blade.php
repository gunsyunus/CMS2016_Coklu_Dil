  ...
  <div class="panel-body">
    ...
    <div class="col-md-12">
        ...
        @foreach($languages as $language)
            ...
            <div class="form-group">
            {{ Form::label('text', 'Alt Banner Buton Adı', array('class'=>'col-md-2 control-label')); }}
            <div class="col-md-10">
            {{ Form::text('languageField['.$language->language_id.'][text]',$language->text,['class'=>'form-control']) }}       
            </div>
            </div>              
