...
<div class="row">
  <div class="col-xs-8 col-sm-6 col-md-8">
    <h1><i class="fa fa-globe fa-fw"></i>DİL YÖNETİMİ</h1>
  ...
  <div class="col-xs-4 col-sm-6 col-md-4 modul-button">
    <a class="btn btn-success" href="{{ URL::to('Pv3/language/new') }}"><i class="fa fa-plus-circle"></i> Dil</a>
    <a class="btn btn-info" href="{{ URL::to('Pv3/language') }}"><i class="fa fa-list"></i> Liste</a>
  </div>
</div>
</div>
