...
<div class="row">
  <div class="col-xs-8 col-sm-6 col-md-8">
    <h1><i class="fa fa-user fa-fw"></i>YÖNETİCİ İŞLEMLERİ</h1>
    <ol class="breadcrumb hidden-xs">
      <li><a href="{{ URL::to('Pv3/Dashboard') }}">Anasayfa</a></li>
      <li><a href="{{ URL::to('Pv3/user') }}">Yöneticiler</a></li>
    </ol>  
  </div>
  <div class="col-xs-4 col-sm-6 col-md-4 modul-button">
    <a class="btn btn-success" href="{{ URL::to('Pv3/user/new') }}"><i class="fa fa-plus-circle"></i> Yönetici</a>
    <a class="btn btn-info" href="{{ URL::to('Pv3/user') }}"><i class="fa fa-list"></i> Liste</a>
  </div>
</div>
</div>
