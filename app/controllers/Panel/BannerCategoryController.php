...
class Panel_BannerCategoryController extends PanelController {
	...
	*/
	...
	public function getIndex() {
        $banners = Banner::with('categorylanguage')->with('bannerlanguage')->where('type','=','category')->orderBy('sort','ASC')->paginate(25);
		return View::make('panel.module.bannerCategory.index',compact('banners'));
	}
	...
	public function getNew() {
		...
		return View::make('panel.module.bannerCategory.new',compact('categories','languages'));
	}
	...
	public function getEdit($id) {
        ...
        return View::make('panel.module.bannerCategory.edit',compact('banners','languages'));
	}
