...
class Panel_BannerController extends PanelController {
	...
	*/
	...
	public function getIndex() {
        $banners = Banner::with('bannerlanguage')->where('type','=','home_slider')->orderBy('sort','ASC')->paginate(25);
		return View::make('panel.module.banner.index',compact('banners'));
	}

	public function getNew() {
        $languages = Language::orderBy('id_language','ASC')->get();
		return View::make('panel.module.banner.new',compact('languages')); 
	}
	...
	public function getEdit($id) {
		...
		return View::make('panel.module.banner.edit',compact('banners','languages'));
	}
