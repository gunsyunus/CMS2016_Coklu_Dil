...
class Panel_BannerBoxController extends PanelController {
	...
	*/
	...
	public function getIndex() {
        $banners = Banner::with('bannerlanguage')->where('type','=','home_box')->orderBy('sort','ASC')->paginate(25);
		return View::make('panel.module.bannerBox.index',compact('banners'));
	}

	public function getNew() {
        $languages = Language::orderBy('id_language','ASC')->get();        
		return View::make('panel.module.bannerBox.new',compact('languages')); 
	}
	...
	public function getEdit($id) {
		...
		return View::make('panel.module.bannerBox.edit',compact('banners','languages'));
	}
